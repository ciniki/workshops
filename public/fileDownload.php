...
function ciniki_workshops_fileDownload($ciniki) {
    ...
    $rc = ciniki_workshops_checkAccess($ciniki, $args['business_id'], 'ciniki.workshops.fileDownload'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    if( !isset($rc['file']) ) {
        return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1447', 'msg'=>'Unable to find file'));
    }
    ...
    if( $rc['file']['extension'] == 'pdf' ) {
        ...
        return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1448', 'msg'=>'Unsupported file type'));
    }
    // Specify Filename
