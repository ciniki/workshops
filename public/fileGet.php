...
function ciniki_workshops_fileGet($ciniki) {
    ...
    $rc = ciniki_workshops_checkAccess($ciniki, $args['business_id'], 'ciniki.workshops.fileGet', 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    $strsql = "SELECT ciniki_workshop_files.id, "
        ...
        . "WHERE ciniki_workshop_files.business_id = '" . ciniki_core_dbQuote($ciniki, $args['business_id']) . "' "
