...
function ciniki_workshops_imageHistory($ciniki) {
    ...
    $rc = ciniki_workshops_checkAccess($ciniki, $args['business_id'], 'ciniki.workshops.imageHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.workshops', 'ciniki_workshop_history', 
        $args['business_id'], 'ciniki_workshop_images', $args['workshop_image_id'], $args['field']);
}
?>
