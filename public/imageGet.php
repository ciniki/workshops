...
function ciniki_workshops_imageGet($ciniki) {
    ...
    $rc = ciniki_workshops_checkAccess($ciniki, $args['business_id'], 'ciniki.workshops.imageGet'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    $strsql = "SELECT ciniki_workshop_images.id, "
        ...
        . "WHERE ciniki_workshop_images.business_id = '" . ciniki_core_dbQuote($ciniki, $args['business_id']) . "' "
