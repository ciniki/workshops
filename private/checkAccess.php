...
// Description
// -----------
// This function will check if the user has access to the workshops module.  
//
// Arguments
// ---------
// ciniki:
...
// <rsp stat='ok' />
//
function ciniki_workshops_checkAccess(&$ciniki, $tnid, $method) {
    //
    ...
    $rc = ciniki_tenants_checkModuleAccess($ciniki, $tnid, 'ciniki', 'workshops');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    $modules = $rc['modules'];
